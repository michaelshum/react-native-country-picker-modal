...
export const Flag = ({ countryCode, withEmoji, withFlagButton, flagSize, }) => withFlagButton ? (React.createElement(View, { style: styles.container }, withEmoji ? (React.createElement(EmojiFlag, { countryCode, flagSize })) : (React.createElement(ImageFlag, { countryCode, flagSize })))) : null;
Flag.defaultProps = {
    withEmoji: true,
    withFlagButton: true,
};
